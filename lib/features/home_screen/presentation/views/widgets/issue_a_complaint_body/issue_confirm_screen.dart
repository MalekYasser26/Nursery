...
class IssueConfirmScreen extends StatelessWidget {
  const IssueConfirmScreen({Key? key}) : super(key: key);
            ...
            children: [
              Column(
                ...
                children: [
                  ...
                  SizedBox(height: 4.h,),
                  Text("Complaint Confirmed",style: GoogleFonts.poppins(fontSize: 18.sp,fontWeight: FontWeight.w600)),
                  Text("Complaint has been sent successfully!",style: GoogleFonts.poppins(fontSize: 12.sp,color: Colors.grey)),
                ],
              ),
              Positioned(
                left: 7.w,
